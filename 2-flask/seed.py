...
if __name__ == '__main__':
    with app.app_context():
        ...
        box1 = Program(type="Boxing", level="Beginner", days="Tuedays & Thursdays", time="3:30PM - 5:00PM", instructor_id=1)
        box2 = Program(type="Boxing",level="Intermediate", days="Tuedays & Thursdays", instructor_id=1)
        box3 = Program(type="Boxing",level="Expert",  time="6:30PM - 8:00PM", instructor_id=3)
        # yoga1 = Program()
        # yoga2 = Program()
        # yoga3 = Program()
        # cycle1 = Program()
        # cycle2 = Program()
        # cycle3 = Program()
        progs = [box1, box2, box3]
        # yoga1, yoga2, yoga3, cycle1, cycle2, cycle3]
